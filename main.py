try:
	...
	os.system("pip install aiodns>=3.0.0,<4.0.0 ")
	os.system("pip install aiohttp-socks>=0.7.0,<0.8.0")
	os.system("pip install aiohttp>=3.8.0,<4.0.0")
	os.system("pip install rich>=12.0.0,<13.0.0")
	print("Done install library ")
	

def lon(z):
	for lon in z +'\n':
		sys.stdout.write(lon)
		sys.stdout.flush()
		time.sleep(0.03)
...
lon("██████╔╝██║███████╗░░╚██╔╝░░███████╗██║░░██║")
lon("╚═════╝░╚═╝╚══════╝░░░╚═╝░░░╚══════╝╚═╝░░╚═╝")
lon("\033[93m genter proxy .")
lon("\033[94m checker proxy .")
print("\n")
admin_user = input("\033[95mchoice :  ")
if admin_user =='1':
	class Proxy:
